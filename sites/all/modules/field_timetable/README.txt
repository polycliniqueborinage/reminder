A Fields module that creates a timetable field that can be display through 
an nice weekly grid. Can be use to display opening hours in lovely way.

Provides a Views display displaying fields using the Timetable plugin :
https://github.com/targoo/timetable
